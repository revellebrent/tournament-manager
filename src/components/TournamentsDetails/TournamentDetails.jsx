...
export default function TournamentDetails() {
  ...
  if (!t) {
    return (
      <main className="details container">
        ...
        <Link to="/" className="details__back">← Back to list</Link>
      </main>
    );
  }
  ...
  return (
    <main className="details container">
      ...
      <p className="details__meta"><strong>Venue:</strong> {t.venue.name}</p>
      ...
      <section className="details__section section">
        ...
        <p className="details__text">Forecast for this venue will appear here.</p>
      </section>

      <section className="details__section section">
        <h2 className="details__h2">Severe Weather Alerts</h2>
        <p className="details__text">Active alerts will appear here.</p>
      </section>
